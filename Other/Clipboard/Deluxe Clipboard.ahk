...
LShift & c::WINDOW("&Copy")    ; COPY to private clipboard
LShift & v::WINDOW("&Paste")   ; PASTE from private clipboard
LShift & x::WINDOW("&Cut")     ; CUT to private clipboard
LShift & a::WINDOW("&Append")  ; APPEND to private clipboard
LShift & y::WINDOW("Cut&Append") ; CUT+APPEND to private clipboard
