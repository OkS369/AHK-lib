...
SYS_ScriptVersion := 0.11.0

; [SYS] autostart section
SYS_AHK_path := "S:\Programs\AutoHotkey"
...
; Adwanced Hot Keys
#Include *i %A_ScriptDir%\_AHK.ahk
; Suspend handlers
...
FileGetAttrib, AHK_Attribs, %A_ScriptDir%\_AHK.ahk
...
Files_Attribs :=Main_File_Attribs AHK_Attribs AOT_Attribs CAW_Attribs NWD_Attribs NWG_Attribs TRA_Attribs TRAY_Attribs Addons_Attribs
IfInString, Files_Attribs, A
{
	FileSetAttrib, -A, %A_ScriptFullPath%
	FileSetAttrib, -A, %A_ScriptDir%\_AHK.ahk
